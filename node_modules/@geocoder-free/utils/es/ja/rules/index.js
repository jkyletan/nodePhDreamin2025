...
const fullAddressTransformer = compose(multiSpaceToOne, multiHyphenToOne, zenToHan);
const splitAddressTransformer = compose(extraHyphenToSpace, multiHyphenToOne, rmTailHyphen, rmHeadHyphen);
