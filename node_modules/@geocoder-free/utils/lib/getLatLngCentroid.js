...
function getLatLngCentroid(latLngInDegr) {
  ...
  for (let i = 0; i < latLngInDegr.length; i += 1) {
    ...
    const lng = degr2rad(lngDegr); // sum of cartesian coordinates
  ...
  const avgZ = sumZ / latLngInDegr.length; // convert average x, y, z coordinate to latitude and longtitude
...
var _default = getLatLngCentroid;
