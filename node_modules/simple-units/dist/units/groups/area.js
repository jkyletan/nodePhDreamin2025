...
area.Editor.add(new FlexibleUnit({
    short: ["%0m²", "%0m^2", "%0m2"],
    long: {
        sg: [
            "square %0meter",
...
}, 1, 0, "metric", [siAreaPrefixes]), new FlexibleUnit({
    short: ["%0a"],
    long: {
        sg: ["%0are"],
        pl: ["%0ares"],
